...
export default function Task2() {
  ...
  return(
    <div style={{minHeight:500,backgroundColor:theme=="Light"?"white":"black"}}>
      ...
      <Button variant='contained' style={{margin:50,color:theme=="Light"?"white":"black",backgroundColor:theme=="Light"?"black":"White"}} onClick={HandleMode}>{theme=="Light"?"Dark":"Light"} Mode</Button>
    </div>
  )
}
